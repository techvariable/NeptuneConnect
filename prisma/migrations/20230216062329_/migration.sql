...
INSERT INTO "new_QueryLog" ("id", "ownerId", "queryParameters", "queryResult", "queryStatus", "queryText", "timeOfExecution", "timeTaken") SELECT "id", "ownerId", "queryParameters", "queryResult", "queryStatus", "queryText", "timeOfExecution", "timeTaken" FROM "QueryLog";
DROP TABLE "QueryLog";
